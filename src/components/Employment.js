  ...
  <div className="employment">
    ...
    <div className="grid-col-2">
      <div className="job">
        ...
        <p>
          Whilst at domus my key responsibility was to help manage the
          development of the new company website, mock up front end designs,
          improve UX and create the CMS architecture / UI. I also...
          <ul>
            <li>Wrote custom HTML email / templates</li>
            <li>
              Setup and maintained external services such as SendGrid,
              Mailchimp, Cookiebot etc.
            </li>
      ...
      <div className="job">
        ...
        <p>
          ...
          someone to do everything (logo, site design/layout, branding etc).
          This has given me the freedom to develop and try out different stacks/
          workflows over the past few years. The experience working with clients
          to a deadline as well as keep their needs in mind at every step has
          been amazing experience that will lend well into any future jobs.
        </p>
      </div>
    </div>
    <SquigglyLineBrown />
